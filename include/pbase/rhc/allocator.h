...
#define P_RHC_STRING_DEFAULT_ALLOCATOR p_rhc_allocator_new_raising()
#endif

#ifndef P_RHC_DYNARRAY_DEFAULT_ALLOCATOR
#define P_RHC_DYNARRAY_DEFAULT_ALLOCATOR p_rhc_allocator_new_raising()
#endif

#ifndef P_RHC_HASHMAP_DEFAULT_ALLOCATOR
#define P_RHC_HASHMAP_DEFAULT_ALLOCATOR p_rhc_allocator_new_raising()
#endif

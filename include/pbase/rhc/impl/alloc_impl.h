...
static void *p_rhc_allocator_try_malloc_impl_(Allocator_i self, size_t size) {
    return p_rhc_malloc_try(size);
}

static void *p_rhc_allocator_try_calloc_impl_(Allocator_i self, size_t size) {
    return p_rhc_calloc_try(size);
}

static void *p_rhc_allocator_try_realloc_impl_(Allocator_i self, void *memory, size_t size) {
    return p_rhc_realloc_try(memory, size);
}

static void p_rhc_allocator_free_impl_(Allocator_i self, void *memory) {
    p_rhc_free(memory);
}

static void *p_rhc_allocator_malloc_impl_(Allocator_i self, size_t size) {
    return p_rhc_malloc(size);
}

static void *p_rhc_allocator_calloc_impl_(Allocator_i self, size_t size) {
    return p_rhc_calloc(size);
}

static void *p_rhc_allocator_realloc_impl_(Allocator_i self, void *memory, size_t size) {
    return p_rhc_realloc(memory, size);
}

static void *p_rhc_allocator_empty_try_malloc_impl_(Allocator_i self, size_t size) {
    return NULL;
}

static void *p_rhc_allocator_empty_try_calloc_impl_(Allocator_i self, size_t size) {
    return NULL;
}

static void *p_rhc_allocator_empty_try_realloc_impl_(Allocator_i self, void *memory, size_t size) {
    return NULL;
}

static void p_rhc_allocator_empty_try_free_impl_(Allocator_i self, void *memory) {
}

static void *p_rhc_allocator_empty_malloc_impl_(Allocator_i self, size_t size) {
    assume(false, "allocator empty raising malloc called");
    return NULL;
}

static void *p_rhc_allocator_empty_calloc_impl_(Allocator_i self, size_t size) {
    assume(false, "allocator empty raising calloc called");
    return NULL;
}

static void *p_rhc_allocator_empty_realloc_impl_(Allocator_i self, void *memory, size_t size) {
    assume(false, "allocator empty raising realloc called");
    return NULL;
}

static void p_rhc_allocator_empty_free_impl_(Allocator_i self, void *memory) {

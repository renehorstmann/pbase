...
#define log_trace(...) p_rhc_log_base_(RHC_LOG_TRACE, __FILE__, __LINE__, __VA_ARGS__)

#define log_debug(...) p_rhc_log_base_(RHC_LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__)

#define log_info(...)  p_rhc_log_base_(RHC_LOG_INFO, __FILE__, __LINE__, __VA_ARGS__)

#define log_warn(...)  p_rhc_log_base_(RHC_LOG_WARN, __FILE__, __LINE__, __VA_ARGS__)

#define log_error(...) p_rhc_log_base_(RHC_LOG_ERROR, __FILE__, __LINE__, __VA_ARGS__)

#define log_wtf(...)   p_rhc_log_base_(RHC_LOG_WTF, __FILE__, __LINE__, __VA_ARGS__)
